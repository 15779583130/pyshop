...
<div class="container">
    ...
    <div class="row searchBox">
        ...
        <div class="col-md-6">
            <div class="searchInput">
                <form class="searchForm myform2" role="search" style="padding: 0px;" action="${pageContext.request.contextPath}/user/search" method="post">
                    <input type="text" name="keywords" class="form-control searchWidth" value="${condition.keywords[0]}" />
    ...
    <form action="${pageContext.request.contextPath}/user/product_list?cid=${cid}" method="post" class="myform">
        <input type="hidden" name="number" class="currentPage">
    ...
    <%--测试:${page.content}--%>
    <!--浏览商品-->
    <span class="text-muted">下面是为您找到的:</span>
    <div class="row" style="min-height:690px">
        ...
        <div class="col-md-12">
            ...
            <h5>当前是第${page.number+1}页,共${page.totalPages}页，总记录数为${page.totalElements}条。</h5>
            <nav style="text-align:center">
                <ul class="pagination">
                    ...
                    <c:if test="${page.number+1!=1}">
                        <li><a href="javascript:findPage(${page.number})"><span>上一页</span></a></li>
                    </c:if>
                    ...
                    <c:forEach begin="1" end="${page.totalPages}" var="i">
                        ...
                        <c:if test="${page.number+1!=i}">
                            <li style="margin-right:5px"><a href="javascript:findPage(${i})">${i}</a></li>
                        </c:if>
                    </c:forEach>

                    <c:if test="${page.number+1==page.totalPages||page.totalPages==0}">
                    ...
                    <c:if test="${page.number+1!=page.totalPages&&page.totalPages!=0}">
                        <li><a href="javascript:findPage(${page.number+2})"> <span>下一页</span>
                        </a></li>
                    </c:if>
                    <li><a href="javascript:findPage(${page.totalPages})"><span>尾页</span></a></li>
                </ul>
            </nav>
